...
- Two resizes admitted concurrently against the same nearly-full queue can together exceed the limit; the scheduler's accounting stays correct, but the limit may be transiently crossed.
