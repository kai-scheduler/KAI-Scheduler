...
- [In-Place Pod Resize](docs/in-place-resize/README.md): Accurate queue accounting for in-place CPU/memory resizes (KEP-1287), with admission checks against queue limits and quota.
