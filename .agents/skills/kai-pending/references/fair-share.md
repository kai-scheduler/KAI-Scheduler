...
generic `PodSchedulingErrors` as a node shortage. You're simply lower priority / further back than
others: over-quota capacity is split between sibling queues by `overQuotaWeight` + priority.
