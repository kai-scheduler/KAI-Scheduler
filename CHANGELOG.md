...
- Fixes an issue where the scheduler failed to start on non-dra enabled clusters [#1239](https://github.com/kai-scheduler/KAI-Scheduler/pull/1239) [itsomri](https://github.com/itsomri)
