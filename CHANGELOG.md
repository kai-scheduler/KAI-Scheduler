...
### Fixed
- The `kai_queue_allocated_gpus` metric now sums GPU allocation across all vendors and includes DRA and MIG GPUs, instead of reporting a single, non-deterministically chosen extended-resource entry. [#1783](https://github.com/kai-scheduler/KAI-Scheduler/issues/1783) [thc1006](https://github.com/thc1006)
