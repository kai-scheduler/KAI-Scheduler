...
func (v *queueValidator) ValidateCreate(ctx context.Context, obj *v2.Queue) (admission.Warnings, error) {
	queue := obj
...
func (v *queueValidator) ValidateUpdate(ctx context.Context, oldObj, newObj *v2.Queue) (admission.Warnings, error) {
	oldQueue := oldObj
	newQueue := newObj
...
func (v *queueValidator) ValidateDelete(ctx context.Context, obj *v2.Queue) (admission.Warnings, error) {
	queue := obj
