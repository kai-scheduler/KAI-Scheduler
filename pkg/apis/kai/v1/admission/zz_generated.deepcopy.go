...
func (in *Admission) DeepCopyInto(out *Admission) {
	*out = *in
	...
	if in.InPlacePodResize != nil {
		in, out := &in.InPlacePodResize, &out.InPlacePodResize
...
func (in *InPlacePodResize) DeepCopyInto(out *InPlacePodResize) {
	*out = *in
	if in.ValidateQuota != nil {
		in, out := &in.ValidateQuota, &out.ValidateQuota
		*out = new(bool)
		**out = **in
	}
	if in.BlockUpsizeOnBoundedQueues != nil {
		in, out := &in.BlockUpsizeOnBoundedQueues, &out.BlockUpsizeOnBoundedQueues
		*out = new(bool)
		**out = **in
	}
}
