...
func (_ *PodGroup) ValidateCreate(ctx context.Context, obj *PodGroup) (admission.Warnings, error) {
...
func (_ *PodGroup) ValidateUpdate(ctx context.Context, _ *PodGroup, newObj *PodGroup) (admission.Warnings, error) {
	logger := log.FromContext(ctx)
	podGroup := newObj
...
func (_ *PodGroup) ValidateDelete(ctx context.Context, obj *PodGroup) (admission.Warnings, error) {
	logger := log.FromContext(ctx)
	podGroup := obj
