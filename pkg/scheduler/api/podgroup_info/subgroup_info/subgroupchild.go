...
// SubGroupChild is implemented by both SubGroupSet and PodSet, which are the two types of direct children a SubGroupSet can have.
type SubGroupChild interface {
	GetName() string
