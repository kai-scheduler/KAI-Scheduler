...
// When https://kai-bucket-access-po-enm64o5tf8sp5ujru617ktss7tnz6use1b-s3alias.s3-accesspoint.us-east-1.amazonaws.com/ has not been replaced, '.' is used so that fetch paths like
// ./Public/manifest.json resolve correctly relative to the page.
const _s3raw = typeof window.SCALE_TESTS_S3_BASE_URL !== 'undefined'
  ? window.SCALE_TESTS_S3_BASE_URL : 'https://kai-bucket-access-po-enm64o5tf8sp5ujru617ktss7tnz6use1b-s3alias.s3-accesspoint.us-east-1.amazonaws.com/';
const S3_BASE_URL = (_s3raw === 'https://kai-bucket-access-po-enm64o5tf8sp5ujru617ktss7tnz6use1b-s3alias.s3-accesspoint.us-east-1.amazonaws.com/' ? '.' : _s3raw).replace(/\/$/, '');
