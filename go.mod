...
require (
	...
	k8s.io/externaljwt v0.35.2
	k8s.io/klog/v2 v2.140.0
	k8s.io/kube-aggregator v0.35.2
	k8s.io/kube-controller-manager v0.35.2
	...
	k8s.io/sample-apiserver v0.35.2
...
replace golang.org/x/oauth2 => golang.org/x/oauth2 v0.28.0
