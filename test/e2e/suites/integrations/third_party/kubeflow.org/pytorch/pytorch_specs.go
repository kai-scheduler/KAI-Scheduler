...
import (
	...
	"github.com/kai-scheduler/kai-scheduler/test/e2e/modules/resources/rd/pytorch"
...
func DescribePytorchSpecs() bool {
	return Describe("Kubeflow.org Pytorch Integration", Ordered, func() {
		var (
